 ...
 * 
 * NOTE: This file supports modular loading. If modules are loaded first,
 * their definitions take precedence over the ones in this file.
 */
...
// Skip if already defined by modules/constants.js
if (typeof DEFAULT_TREE_RULES === 'undefined') {
...
- 
`;
} // end DEFAULT_TREE_RULES conditional

// =============================================================================
// TREE VIEWER CONFIGURATION
// =============================================================================

// Skip if already defined by modules/config.js
if (typeof TREE_CONFIG === 'undefined') {
var TREE_CONFIG = {
    wheel: {
        baseRadius: 120,
        tierSpacing: 100,
...
} // end TREE_CONFIG conditional

// =============================================================================
// GROWTH DSL - LLM-Driven Procedural Tree Generation
// =============================================================================

// Skip if already defined by modules/growthDSL.js
if (typeof GROWTH_DSL === 'undefined') {
var GROWTH_DSL = {
...
// Skip if already defined by modules/constants.js
if (typeof DIFFICULTY_PROFILES === 'undefined') {
...
} // end DIFFICULTY_PROFILES conditional

// =============================================================================
// SETTINGS
// =============================================================================

// Skip if already defined by modules/state.js
...
} // end settings conditional

// Custom difficulty profiles (user-created) - skip if defined
if (typeof customProfiles === 'undefined') { var customProfiles = {}; }

// Per-node XP requirement overrides (formId -> requiredXP) - skip if defined
if (typeof xpOverrides === 'undefined') { var xpOverrides = {}; }
...
// Skip if already defined by modules/constants.js
if (typeof DEFAULT_COLOR_PALETTE === 'undefined') {
...
} // end DEFAULT_COLOR_PALETTE conditional

// Get or assign a color for a school - skip if defined by modules/colorUtils.js
if (typeof getOrAssignSchoolColor === 'undefined') {
...
} // end getOrAssignSchoolColor conditional (includes all color functions)

// Key name to DirectInput scancode mapping - skip if defined by modules/constants.js
if (typeof KEY_CODES === 'undefined') {
var KEY_CODES = {
...
// Global helper to update slider fill - skip if defined by modules/state.js
if (typeof updateSliderFillGlobal === 'undefined') {
function updateSliderFillGlobal(slider) {
    if (!slider) return;
    var percent = (slider.value - slider.min) / (slider.max - slider.min) * 100;
    slider.style.setProperty('--slider-fill', percent + '%');
}
} // end updateSliderFillGlobal conditional

// Skip state if defined by modules/state.js
...
// Skip if defined by modules/spellCache.js
...
} // end SpellCache conditional

// =============================================================================
// TREE PARSER
// =============================================================================

// Helper to log messages - skip if defined by modules/treeParser.js
if (typeof logTreeParser === 'undefined') {
...
} // end logTreeParser conditional

// Skip if defined by modules/treeParser.js
if (typeof TreeParser === 'undefined') {
var TreeParser = {
    nodes: new Map(),
    edges: [],
    schools: {},
...
} // end TreeParser conditional

// =============================================================================
// WHEEL RENDERER
// =============================================================================

// Skip if already defined by modules/wheelRenderer.js
